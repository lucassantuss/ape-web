...
const exerciciosInfo = {
  ...
  roscaDiretaHalteres: {
    ...
    descricao: "Exercício de bíceps feito com halteres. Alterne ou faça os dois braços simultaneamente, mantendo os cotovelos firmes.",
    imagens: [
      "https://static1.minhavida.com.br/articles/28/af/90/ef/65ef2fafd8480cdibqbudriorcr3wdflcvylxsylx3bo-65eivbmdzes-kzmnxjxs-enswzgv0ycxejtiworoosmdjtfhryeoittuobpp-0dcd9uy5ict6-wn0scgyzcer4dh5-utdyttssmhcptipfb2gpyqamxafsu-orig-1-orig-1.",
    ]
  },
  ...
  prancha: {
    nome: "Prancha",
    descricao: "Exercício isométrico para abdômen e core. Apoie-se nos antebraços e mantenha o corpo alinhado sem deixar o quadril cair.",
    imagens: [
      "https://www.hipertrofia.org/blog/wp-content/uploads/2019/02/prancha-musculos-envolvidos.jpg"
    ]
  },
  cadeiraFlexora: {
